<h2><a href="https://leetcode.com/problems/nth-magical-number">878. Nth Magical Number</a></h2><h3>Hard</h3><hr><p>A positive integer is <em>magical</em> if it is divisible by either <code>a</code> or <code>b</code>.</p>
